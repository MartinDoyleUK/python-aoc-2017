...
Welcome to your Python learning journey with Advent of Code 2017!
...
5. Paste it into `inputs/day01.txt`
...
def solve_part1(puzzle_input):
    print(f"Input: {puzzle_input}")  # See what you're working with
    # Your code here
```
...
2. **Test with Examples**: The problem usually has example inputs
3. **Ask for Help**: Use Claude in VSCode to explain concepts
4. **Google is Your Friend**: "How to loop through string in Python"
